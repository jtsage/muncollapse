...
FAVICON_BASEURL = https://github.com/munin-monitoring/munin/blob/master/web/static/img/favicons/
...
main:
	...
	$(HTTP_FETCH) $(CWD)/static/js/bootstrap.min.js $(BOOTSTRAP_CSS_URL)
